...
=======
    ...
    def bootstrap_(self, X, num_samples):
        """
        Genera muestras bootstrap a partir de un conjunto de datos y entrena el modelo con cada muestra bootstrap.
        
        Parameters:
        X (list): Conjunto de datos de entrenamiento.
        num_samples (int): Número de muestras bootstrap a generar.
        
        Returns:
        list: Lista de tuplas que contienen la clase verdadera y la predicción del modelo para cada muestra bootstrap.
        """
        boostraps =  list()
